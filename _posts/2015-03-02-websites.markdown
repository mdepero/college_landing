...
<p>Another large website I worked on. The most time consuming part of this site were the <a href="http://www.warnermcilvainedentistry.com/forms.php" target="_BLANK">Forms and Appointments</a> pages. The Health History and Appointment Request form were all hand coded in HTML with PHP to recieve them, and the javascript that "validates" them (although I now know javascript validation is not the most secure way to validate a form)
</p>
